...
from compression.compression_algo import image_compress
                ...
                for i in range(1):  # 16
                    ...
                    for j in range(batch_size):
                        ...
                        for k in range(len(fake_imgs)):
                            ...
                            compressed_im, de_compressed_im = image_compress(im)
                            im = Image.fromarray(compressed_im)
                            fullpath = '%s_g%d_compressed.png' % (save_name, k)
                            im.save(fullpath)

                            im = Image.fromarray(de_compressed_im)
                            fullpath = '%s_g%d_de_compressed.png' % (save_name, k)
                            im.save(fullpath)
